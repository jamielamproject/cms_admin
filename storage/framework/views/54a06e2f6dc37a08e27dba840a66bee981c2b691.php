            ...
            <div class="row">
              <div class="col-xs-12">
              	  <div class="box box-info">
                        <!-- form start -->                        
                         <div class="box-body">
                            <?php echo Form::open(array('url' =>'admin/updateupsshipping', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')); ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10 col-md-4">
                                    <label class=" control-label">
                                          <input type="radio" name="shippingEnvironment" value="0" class="flat-red" <?php if($result['ups_shipping']['ups_shipping'][0]->shippingEnvironment==0): ?> checked <?php endif; ?> > &nbsp;<?php echo e(trans('labels.Test')); ?>

                                    </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    
                                    <label class=" control-label">
                                          <input type="radio" name="shippingEnvironment" value="1" class="flat-red" <?php if($result['ups_shipping']['ups_shipping'][0]->shippingEnvironment==1): ?> checked <?php endif; ?> >  &nbsp; <?php echo e(trans('labels.Production')); ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10 col-md-4">
                                    <select name="serviceType[]" class="form-control" multiple="multiple" data-placeholder="Select a State" style="width: 100%;">
                                   	  <option <?php if(in_array('US_01', explode(',', $result['ups_shipping']['ups_shipping'][0]->serviceType))): ?> selected <?php endif; ?> value="US_01"><?php echo e(trans('labels.NextDayAir')); ?> </option>
                                      <option <?php if(in_array('US_02', explode(',', $result['ups_shipping']['ups_shipping'][0]->serviceType))): ?> selected <?php endif; ?> value="US_02"><?php echo e(trans('labels.2ndDayAir')); ?> </option>
                                      <option <?php if(in_array('US_03', explode(',', $result['ups_shipping']['ups_shipping'][0]->serviceType))): ?> selected <?php endif; ?> value="US_03"><?php echo e(trans('labels.Ground')); ?></option>
                                      <!--<option <?php if(in_array('IN_07', explode(',', $result['ups_shipping']['ups_shipping'][0]->serviceType))): ?> selected <?php endif; ?> value="IN_07">Worldwide Express </option>-->
                                      <!--<option <?php if(in_array('IN_54', explode(',', $result['ups_shipping']['ups_shipping'][0]->serviceType))): ?> selected <?php endif; ?> value="IN_54">Worldwide Express Plus</option>-->
                                      <!--<option <?php if(in_array('IN_08', explode(',', $result['ups_shipping']['ups_shipping'][0]->serviceType))): ?> selected <?php endif; ?> value="IN_08">Worldwide Expedited</option>-->
                                      <!--<option <?php if(in_array('IN_11', explode(',', $result['ups_shipping']['ups_shipping'][0]->serviceType))): ?> selected <?php endif; ?> value="IN_11">Standard</option>-->
                                      <option <?php if(in_array('US_12', explode(',', $result['ups_shipping']['ups_shipping'][0]->serviceType))): ?> selected <?php endif; ?> value="US_12"><?php echo e(trans('labels.3DaySelect')); ?> </option>
                                      <option <?php if(in_array('US_13', explode(',', $result['ups_shipping']['ups_shipping'][0]->serviceType))): ?> selected <?php endif; ?> value="US_13"><?php echo e(trans('labels.NextDayAirSaver')); ?> </option>
                                      <option <?php if(in_array('US_14', explode(',', $result['ups_shipping']['ups_shipping'][0]->serviceType))): ?> selected <?php endif; ?> value="US_14"><?php echo e(trans('labels.NextDayAirEarlyAM')); ?></option>
                                      <option <?php if(in_array('US_59', explode(',', $result['ups_shipping']['ups_shipping'][0]->serviceType))): ?> selected <?php endif; ?> value="US_59"><?php echo e(trans('labels.2ndDayAirAM')); ?></option>
                                    </select>
                            ...
                            <!--<div class="form-group">
								...
								<div class="col-sm-10 col-md-4">
									<?php echo Form::text('title', $result['ups_shipping']['ups_shipping'][0]->title, array('class'=>'form-control', 'id'=>'title')); ?>
                            ...
                            <div class="form-group">
								...
								<div class="col-sm-10 col-md-4">
									<?php echo Form::text('access_key',  $result['ups_shipping']['ups_shipping'][0]->access_key, array('class'=>'form-control', 'id'=>'access_key')); ?>
							...
							<div class="form-group">
								...
								<div class="col-sm-10 col-md-4">
									<?php echo Form::text('user_name',  $result['ups_shipping']['ups_shipping'][0]->user_name, array('class'=>'form-control', 'id'=>'user_name')); ?>
                            ...
                            <div class="form-group">
								...
								<div class="col-sm-10 col-md-4">
									<?php echo Form::text('password',  $result['ups_shipping']['ups_shipping'][0]->password, array('class'=>'form-control', 'id'=>'password')); ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10 col-md-4">
                                    <label class=" control-label">
                                          <input type="radio" name="pickup_method" value="01" class="flat-red" <?php if($result['ups_shipping']['ups_shipping'][0]->pickup_method==01): ?> checked <?php endif; ?> > &nbsp;<?php echo e(trans('labels.DailyPickup')); ?>

                                    </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    
                                    <label class=" control-label">
                                          <input type="radio" name="pickup_method" value="03" class="flat-red" <?php if($result['ups_shipping']['ups_shipping'][0]->pickup_method==03): ?> checked <?php endif; ?> >  &nbsp;
                                          <?php echo e(trans('labels.CustomerCounter')); ?>  
                                    </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    
                                    <label class=" control-label">
                                          <input type="radio" name="pickup_method" value="06" class="flat-red" <?php if($result['ups_shipping']['ups_shipping'][0]->pickup_method==06): ?> checked <?php endif; ?> >  &nbsp;<?php echo e(trans('labels.OneTimePickup')); ?>  
                                    </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    
                                    <label class=" control-label">
                                          <input type="radio" name="pickup_method" value="07" class="flat-red" <?php if($result['ups_shipping']['ups_shipping'][0]->pickup_method==07): ?> checked <?php endif; ?> >  &nbsp;<?php echo e(trans('labels.OnCallAirPickup')); ?> 
                                    </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    
                                    <label class=" control-label">
                                          <input type="radio" name="pickup_method" value="19" class="flat-red" <?php if($result['ups_shipping']['ups_shipping'][0]->pickup_method==19): ?> checked <?php endif; ?> >  &nbsp; <?php echo e(trans('labels.LetterCenter')); ?>  
                                    </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    
                                    <label class=" control-label">
                                          <input type="radio" name="pickup_method" value="20" class="flat-red" <?php if($result['ups_shipping']['ups_shipping'][0]->pickup_method==20): ?> checked <?php endif; ?> >  &nbsp; 
                            ...
                            <div class="form-group">
								...
								<div class="col-sm-10 col-md-4">
									<?php echo Form::text('address_line_1',  $result['ups_shipping']['ups_shipping'][0]->address_line_1, array('class'=>'form-control', 'id'=>'address_line_1')); ?>
                            ...
                            <div class="form-group">
								...
								<div class="col-sm-10 col-md-4">
									<?php echo Form::text('state',  $result['ups_shipping']['ups_shipping'][0]->state, array('class'=>'form-control', 'id'=>'state')); ?>
                            ...
                            <div class="form-group">
								...
								<div class="col-sm-10 col-md-4">
									<?php echo Form::text('post_code',  $result['ups_shipping']['ups_shipping'][0]->post_code, array('class'=>'form-control', 'id'=>'post_code')); ?>
                            ...
                            <div class="form-group">
								...
								<div class="col-sm-10 col-md-4">
									<?php echo Form::text('city',  $result['ups_shipping']['ups_shipping'][0]->city, array('class'=>'form-control', 'id'=>'city')); ?>
								...
								<div class="col-sm-10 col-md-4">
									<select name="country" class="form-control select2">
                                        <?php $__currentLoopData = $result['countries']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $countries): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option 
                                                <?php if($result['ups_shipping']['ups_shipping'][0]->country == $countries->countries_iso_code_2): ?>
                                                    selected
                                                <?php endif; ?>
