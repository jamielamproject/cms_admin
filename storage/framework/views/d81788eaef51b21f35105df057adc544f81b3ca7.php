  ...
  <section class="invoice" style="margin: 15px;">
      ...
      <div class="row invoice-info">
        <div class="col-sm-4 invoice-col">
          ...
          <address>
            <?php echo e(trans('labels.CustomerName')); ?>:<strong><?php echo e($data['orders_data'][0]->customers_name); ?></strong><br>
            <?php echo e(trans('labels.Address')); ?>: <?php echo e($data['orders_data'][0]->customers_street_address); ?> <br>
        ...
        <div class="col-sm-4 invoice-col">
          ...
          <address>
          <?php echo e(trans('labels.CustomerName')); ?>: <strong><?php echo e($data['orders_data'][0]->delivery_name); ?></strong><br>
          <?php echo e(trans('labels.Address')); ?>: <?php echo e($data['orders_data'][0]->delivery_street_address); ?> <br>
      ...
      <div class="row">
        ...
        <div class="col-xs-7">
          ...
          <p class="text-muted well well-sm no-shadow" style="text-transform:capitalize; word-break:break-all;">
           		<?php echo e($data['orders_data'][0]->customer_remark); ?>
